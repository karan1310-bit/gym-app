...
export default function Generator(props) {
    ...
    return (
        <SectionWrapper id={'generate'} header={"generate your workout"} title={['It\'s', 'Huge', 'o\'clock']}>
            ...
            <Header index={'02'} title={'Lock on yourself'} description={"Select the muscles for annihilation."} />
            ...
            <Header index={'03'} title={'Become Goku'} description={"Select your ultimate objective."} />
